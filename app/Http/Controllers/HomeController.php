...
public function updateoutofexpense(request $request)
   ...
   $formattedDateTime = Carbon::now()->format('Y-m-d H:i:s');
    ...
    public function userwallet()
    {
        ...
        // if($keyDownload->file_status === 1)
        // {
        //     $email = $user->email;
        
    
        // $to = $email;
        // // $to = 'ramandeep@takniik.com';
        // $subject = 'Email otp';
        // $otp = mt_rand(100000, 999999);
        // // Construct the email body using the values from the $data array
        // $message = "OTP: {$otp}";
    
        // $headers = 'From: ramandeep@takniik.com' . "\r\n" .
        //     'Reply-To: ' . $to . "\r\n" .
        //     'X-Mailer: PHP/' . phpversion();
        // // $headers .= "\r\nBcc: devanshu@takniik.com";
